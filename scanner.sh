...
screen -d -m -S sox bash --noprofile --norc -c 'rtl_fm -L 10 -p -1 -T -f 155190k -f 154935k -f 155370k -f 155625k -f 155700k -f 155685k -f 156210k -M nfm -s 12.5k -l 550 -g 49.2 -t 2 - 2>$PWD/fm-in | \
